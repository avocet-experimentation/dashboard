...
export type Scalars = {
  ...
  ConditionReference: { input: any; output: any; }
...
export type ExperimentDraft = {
  ...
  hypotheses: Array<HypothesisInput>;
...
export type FeatureFlag = {
  ...
  createdAt: Scalars['Float']['output'];
  description: Maybe<Scalars['String']['output']>;
  environmentNames: Scalars['EnvironmentNames']['output'];
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
...
export type FeatureFlagDraft = {
  description?: InputMaybe<Scalars['String']['input']>;
  environmentNames: Scalars['EnvironmentNames']['input'];
  name: Scalars['String']['input'];
...
export type Hypothesis = {
  ...
  baseConditionRef: Scalars['ConditionReference']['output'];
  compareOperator: Scalars['String']['output'];
  compareValue: Scalars['TextPrimitive']['output'];
  dependentName: Scalars['String']['output'];
  id: Scalars['ID']['output'];
  testConditionRef: Scalars['ConditionReference']['output'];
};

export type HypothesisInput = {
  analysis: Scalars['String']['input'];
  baseConditionRef: Scalars['ConditionReference']['input'];
  compareOperator: Scalars['String']['input'];
  compareValue: Scalars['TextPrimitive']['input'];
  dependentName: Scalars['String']['input'];
  id: Scalars['ID']['input'];
  testConditionRef: Scalars['ConditionReference']['input'];
};

export type Metric = {
  __typename?: 'Metric';
  fieldName: Scalars['String']['output'];
  type: Scalars['MetricDataType']['output'];
};

export type MetricInput = {
  fieldName: Scalars['String']['input'];
  type: Scalars['MetricDataType']['input'];
};

export type Mutation = {
  __typename?: 'Mutation';
  completeExperiment: Maybe<Scalars['Boolean']['output']>;
  ...
  deleteExperiment: Maybe<Scalars['ID']['output']>;
  deleteFeatureFlag: Maybe<Scalars['ID']['output']>;
  deleteSDKConnection: Maybe<Scalars['ID']['output']>;
  deleteUser: Maybe<Scalars['ID']['output']>;
  pauseExperiment: Maybe<Scalars['Boolean']['output']>;
  startExperiment: Maybe<Scalars['Boolean']['output']>;
...
export type MutationCompleteExperimentArgs = {
  id: Scalars['ID']['input'];
};
...
export type MutationPauseExperimentArgs = {
  id: Scalars['ID']['input'];
};
...
export type PartialExperimentWithId = {
  ...
  hypotheses?: InputMaybe<Array<HypothesisInput>>;
  hypothesis?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['ID']['input'];
  name?: InputMaybe<Scalars['String']['input']>;
  startTimestamp?: InputMaybe<Scalars['Float']['input']>;
...
export type PartialSdkConnectionWithId = {
  ...
  apiKeyHash?: InputMaybe<Scalars['String']['input']>;
  createdAt?: InputMaybe<Scalars['Float']['input']>;
  description?: InputMaybe<Scalars['String']['input']>;
...
export type CreateExperimentMutation = { __typename?: 'Mutation', createExperiment: { __typename?: 'Experiment', id: string, createdAt: number, updatedAt: number, name: string, environmentName: string, status: ExperimentStatus, type: ExperimentType, description: string | null, hypothesis: string | null, startTimestamp: number | null, endTimestamp: number | null, definedTreatments: any, flagIds: Array<string>, enrollment: { __typename?: 'Enrollment', attributes: Array<string>, proportion: number }, groups: Array<{ __typename?: 'ExperimentGroup', id: string, name: string, description: string | null, proportion: number, cycles: number, sequence: Array<string> }>, dependents: Array<{ __typename?: 'Metric', fieldName: string, type: any }>, hypotheses: Array<{ __typename?: 'Hypothesis', id: string, dependentName: string, analysis: string, compareValue: any, compareOperator: string, baseConditionRef: any, testConditionRef: any }> } };
...
export type ExperimentQuery = { __typename?: 'Query', experiment: { __typename?: 'Experiment', id: string, createdAt: number, updatedAt: number, name: string, environmentName: string, status: ExperimentStatus, type: ExperimentType, description: string | null, hypothesis: string | null, startTimestamp: number | null, endTimestamp: number | null, definedTreatments: any, flagIds: Array<string>, enrollment: { __typename?: 'Enrollment', attributes: Array<string>, proportion: number }, groups: Array<{ __typename?: 'ExperimentGroup', id: string, name: string, description: string | null, proportion: number, cycles: number, sequence: Array<string> }>, dependents: Array<{ __typename?: 'Metric', fieldName: string, type: any }>, hypotheses: Array<{ __typename?: 'Hypothesis', id: string, dependentName: string, analysis: string, compareValue: any, compareOperator: string, baseConditionRef: any, testConditionRef: any }> } | null };
...
export type UpdateExperimentMutation = { __typename?: 'Mutation', updateExperiment: { __typename?: 'Experiment', id: string, createdAt: number, updatedAt: number, name: string, environmentName: string, status: ExperimentStatus, type: ExperimentType, description: string | null, hypothesis: string | null, startTimestamp: number | null, endTimestamp: number | null, definedTreatments: any, flagIds: Array<string>, enrollment: { __typename?: 'Enrollment', attributes: Array<string>, proportion: number }, groups: Array<{ __typename?: 'ExperimentGroup', id: string, name: string, description: string | null, proportion: number, cycles: number, sequence: Array<string> }>, dependents: Array<{ __typename?: 'Metric', fieldName: string, type: any }>, hypotheses: Array<{ __typename?: 'Hypothesis', id: string, dependentName: string, analysis: string, compareValue: any, compareOperator: string, baseConditionRef: any, testConditionRef: any }> } | null };
...
export type DeleteExperimentMutation = { __typename?: 'Mutation', deleteExperiment: string | null };
...
export type StartExperimentMutation = { __typename?: 'Mutation', startExperiment: boolean | null };
...
export type PauseExperimentMutation = { __typename?: 'Mutation', pauseExperiment: boolean | null };

export type CompleteExperimentMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type CompleteExperimentMutation = { __typename?: 'Mutation', completeExperiment: boolean | null };
...
export type CreateFeatureFlagMutation = { __typename?: 'Mutation', createFeatureFlag: { __typename?: 'FeatureFlag', id: string, createdAt: number, updatedAt: number, name: string, description: string | null, value: any, environmentNames: any, overrideRules: Array<{ __typename?: 'ExperimentReference', type: any, name: string, status: ExperimentStatus, id: string, description: string | null, environmentName: string, startTimestamp: number | null, endTimestamp: number | null, enrollment: { __typename?: 'Enrollment', attributes: Array<string>, proportion: number } } | { __typename?: 'ForcedValue', type: any, value: any, id: string, description: string | null, environmentName: string, startTimestamp: number | null, endTimestamp: number | null, enrollment: { __typename?: 'Enrollment', attributes: Array<string>, proportion: number } }> } };
...
export type CreateSdkConnectionMutation = { __typename?: 'Mutation', createSDKConnection: { __typename?: 'SDKConnection', id: string, name: string, allowedOrigins: Array<string>, apiKeyHash: string, description: string | null, environmentId: string, updatedAt: number, createdAt: number } };
...
export type AllSdkConnectionsQuery = { __typename?: 'Query', allSDKConnections: Array<{ __typename?: 'SDKConnection', id: string, name: string, allowedOrigins: Array<string>, apiKeyHash: string, description: string | null, environmentId: string, updatedAt: number, createdAt: number }> };
...
export type UpdateSdkConnectionMutation = { __typename?: 'Mutation', updateSDKConnection: { __typename?: 'SDKConnection', id: string, name: string, allowedOrigins: Array<string>, apiKeyHash: string, description: string | null, environmentId: string, updatedAt: number, createdAt: number } | null };
...
export const StartExperimentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"startExperiment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startExperiment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<StartExperimentMutation, StartExperimentMutationVariables>;
export const PauseExperimentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"pauseExperiment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pauseExperiment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<PauseExperimentMutation, PauseExperimentMutationVariables>;
export const CompleteExperimentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"completeExperiment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completeExperiment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}]}]}}]} as unknown as DocumentNode<CompleteExperimentMutation, CompleteExperimentMutationVariables>;
export const CreateFeatureFlagDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"createFeatureFlag"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"newEntry"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FeatureFlagDraft"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createFeatureFlag"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"newEntry"},"value":{"kind":"Variable","name":{"kind":"Name","value":"newEntry"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"value"}},{"kind":"Field","name":{"kind":"Name","value":"environmentNames"}},{"kind":"Field","name":{"kind":"Name","value":"overrideRules"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"environmentName"}},{"kind":"Field","name":{"kind":"Name","value":"enrollment"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attributes"}},{"kind":"Field","name":{"kind":"Name","value":"proportion"}}]}},{"kind":"Field","name":{"kind":"Name","value":"startTimestamp"}},{"kind":"Field","name":{"kind":"Name","value":"endTimestamp"}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ExperimentReference"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ForcedValue"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"value"}}]}}]}}]}}]}}]} as unknown as DocumentNode<CreateFeatureFlagMutation, CreateFeatureFlagMutationVariables>;
